...
object PlanRepository extends JsonSupport {
  ...
  private val executionSaveFolder = "/tmp/data-caterer/execution"
  private val planSaveFolder = "/tmp/data-caterer/plan"
  implicit val ec: ExecutionContextExecutor = ExecutionContext.global

  def apply(): Behavior[PlanCommand] = Behaviors.receiveMessage {
